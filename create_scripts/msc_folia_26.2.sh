...
SERVER_DIR="$1"
FOLIA_VERSION="26.2"
FOLIA_JAR="folia-26.2.jar"
FOLIA_URL="https://fill-data.papermc.io/v1/objects/9a728381da3a3bea6732ee210519f8f6ab7d6affe132a430ee167c44c4603d08/folia-26.2-6.jar"
RAM_ALLOCATION="6G"
...
download_server() {
    ...
    echo "Downloading Folia $FOLIA_VERSION (experimental build)..."
    ...
    echo "Folia $FOLIA_VERSION server setup complete! Note: this is an experimental build, use with caution."
}
